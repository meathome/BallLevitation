...
#define SERVICE_UUID "12345678-1234-1234-1234-123456789ab4"
#define TX_UUID      "abcd1234-5678-1234-5678-abcdef123454"
#define RX_UUID      "dcba4321-8765-4321-8765-fedcba654324"
...
void setup() {
  ...
  BLEDevice::init("BallLevitation_4");
